<?php
	include_once("./model/ManterSetor.php"); 
	...
	$lista = $manterSetor->listar();
        ...
        foreach ($lista as $obj) {
            ...
            if($obj->excluir){
                echo "  <td align='center'><button class='btn btn-primary btn-sm' type='button' onclick='alterar(".$obj->id.",\"".$obj->sigla."\",\"".$obj->descricao."\")'><i class='fas fa-edit'></i></button>&nbsp;&nbsp;<button class='btn btn-danger btn-sm' type='button' onclick='excluir(".$obj->id.",\"".$obj->perfil."\")'><i class='far fa-trash-alt'></i></button></td>";
            } else {
