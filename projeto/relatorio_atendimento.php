...
<html>
    ...
    <body id="page-top">
        ...
        if ($termino != 0) {
            ...
            $where .= " f.atendido <='" . $termino . " 19:00'";
            $cont_param++;
        }
            ...
            <div id="containerAtendimento" role="main" class="align-items-center" style="width:100%"><h2 class="text-center">Relatório de Atendimentos</h2><img src="img/iconexcel.png" width="30" height="30" class="d-print-none" id="btnExport" />
                    <table class="table table-striped" id="atendimentos">
                        <tr class="thead-dark">
                            ...
                            <th class="header c2 text-nowrap text-center" style="" scope="col" style="width:50%"><i class="fa fa-minus-square text-white c4" onclick="naover('c4');" aria-hidden="true" title="Remover coluna"></i> TEMPO FILA </th>
                            <th class="header c2 text-nowrap text-center" style="" scope="col" style="width:50%"><i class="fa fa-minus-square text-white c5" onclick="naover('c5');" aria-hidden="true" title="Remover coluna"></i> ATENDIDO </th>
                            <th class="header c2 text-nowrap text-center" style="" scope="col" style="width:50%"><i class="fa fa-minus-square text-white c6" onclick="naover('c6');" aria-hidden="true" title="Remover coluna"></i> TEMPO </th>
                            <th class="header c3 text-nowrap text-center" style="" scope="col"><i class="fa fa-minus-square text-white c7" onclick="naover('c7');" aria-hidden="true" title="Remover coluna"></i> SERVIÇO </th>
                            <th class="header c4 text-nowrap text-center" style="" scope="col"><i class="fa fa-minus-square text-white c8" onclick="naover('c8');" aria-hidden="true" title="Remover coluna"></i> ATENDENTE </th>
                            <th class="header c5 text-nowrap text-center" style="" scope="col"><i class="fa fa-minus-square text-white c9" onclick="naover('c9');" aria-hidden="true" title="Remover coluna"></i> GUICHÊ</th>
                            <th class="header c6 lastcol text-nowrap text-center" style="" scope="col"><i class="fa fa-minus-square text-white c10" onclick="naover('c10');" aria-hidden="true" title="Remover coluna"></i> DETALHAMENTO </th>
                        </tr>
                        <?php
                        foreach ($atendimentos as $obj) {
                            ...
                            <tr class="">
                                ...
                                <td class="cell c2 text-dark " style=""><?= $obj->tempo_fila ?> minutos</td>
