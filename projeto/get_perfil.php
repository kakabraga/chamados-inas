<?php
	...
	$lista = $manterPerfil->listar();
        ...
        foreach ($lista as $obj) {
            ...
            echo "  <td>".$obj->nome."</td>";
            if($obj->excluir){
                echo "  <td align='center'><button class='btn btn-primary btn-sm' type='button' onclick='alterar(".$obj->id.",\"".$obj->nome."\")'><i class='fas fa-edit'></i></button>&nbsp;&nbsp;<button class='btn btn-danger btn-sm' type='button' onclick='excluir(".$obj->id.",\"".$obj->perfil."\")'><i class='far fa-trash-alt'></i></button></td>";
            } else {
