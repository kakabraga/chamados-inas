                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4 border-primary" style="max-width:900px">
                            <div class="row ml-0 card-header py-2 bg-gradient-primary" style="width:100%">
                                ...
                                <div class="col mb-0">
                                    <span style="align:left;" class="h5 m-0 font-weight text-white">Módulos</span>
                                </div>
                                <div class="col text-right" style="max-width:20%">
                                    <button id="btn_cadastrar" class="btn btn-outline-light btn-sm" type="button" data-toggle="collapse" data-target="#form_modulo" aria-expanded="false" aria-controls="form_modulo">
