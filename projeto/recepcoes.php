                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4 border-primary" style="max-width:900px">
                            ...
                            <div class="card-body">
                                <table id="recepcoes" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">ID</th>
