    ...
    <head>
        ...
        <script type="text/javascript" class="init">
            ...
            function excluir(id, tipo) {
                $('#delete').attr('href', 'del_liminar.php?id=' + id);
                $('#tipo_excluir').text(tipo);
                $('#confirm').modal({show: true});              
            }
            function alterar(id, tipo) {
                $('#id').val(id);
                $('#tipo').val(tipo);
                $('#form_liminar').collapse("show");
                $('#btn_cadastrar').hide();
            }
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4 border-primary" style="max-width:900px">
                            ...
                            <div class="card-body">
                                <table id="liminares" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th scope="col">ID</th>
            ...
            <div class="modal-dialog modal-sm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Deseja excluir <strong>"<span id="tipo_excluir"></span>"</strong>?</p>
                    </div>
