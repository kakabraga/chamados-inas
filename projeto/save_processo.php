...
$processo->numero                   = isset($_POST['numero']) ? strtotime($_POST['numero']) : '';
$processo->autuacao                 = isset($_POST['autuacao']) ? strtotime($_POST['autuacao']) : '';
$processo->instancia                = isset($_POST['instancia']) ? strtotime($_POST['instancia']) : '';
$processo->sei                      = isset($_POST['sei']) ? strtotime($_POST['sei']) : '';
$processo->classe_judicial          = isset($_POST['classe_judicial']) ? strtotime($_POST['classe_judicial']) : '';
$processo->processo_vinculado       = isset($_POST['processo_vinculado']) ? strtotime($_POST['processo_vinculado']) : '';
$processo->guia                     = isset($_POST['guia']) ? strtotime($_POST['guia']) : '';
...
$processo->liminar                  =  isset($_POST['liminar']) ? strtotime($_POST['liminar']) : '';
