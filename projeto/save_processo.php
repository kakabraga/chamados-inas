...
$processo->valor_guia               = isset($_POST['valor_guia']) ? str_replace('R$','',$_POST['valor_guia'])  : 0;
$processo->valor_causa              = isset($_POST['valor_causa']) ? str_replace('R$','',$_POST['valor_causa']) : 0;
$processo->deposito_judicial        = isset($_POST['deposito_judicial']) ? str_replace('R$','',$_POST['deposito_judicial']) : 0;
$processo->reembolso                = isset($_POST['reembolso']) ? str_replace('R$','',$_POST['reembolso']) : 0;
$processo->custas                   = isset($_POST['custas']) ? str_replace('R$','',$_POST['custas']) : 0;
$processo->honorarios               = isset($_POST['honorarios']) ? str_replace('R$','',$_POST['honorarios']) : 0;
$processo->danos_morais             = isset($_POST['danos_morais']) ? str_replace('R$','',$_POST['danos_morais']) : 0;
