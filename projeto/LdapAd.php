...
*  adLDAP class
* 
* CLASSE QUE CONVERSA COM O LDAP
*/
...
class adLDAP {
    ...
    * @var string
    */
	protected $_account_suffix="@governo.gdfnet.df";
    ...
    * @var string
    */
	protected $_base_dn = "DC=governo,DC=gdfnet,DC=df"; 
    ...
    * @var array
    */
	//protected $_domain_controllers = array ("a131s01.cepetb.net.br");
	protected $_domain_controllers = array ("GOVERNO111.governo.gdfnet.df");
    /**
    ...
    * @var bool
    */
	protected $_real_primarygroup=false;
    ...
    */
    public function user_create($attributes){
        ...
        if (!array_key_exists("container",$attributes)){ return ("Missing compulsory field [container]"); }
        if (!is_array($attributes["container"])){ return ("Container attribute must be an array."); }
        array_key_exists("password",$attributes); /* && !$this->_use_ssl){ 
