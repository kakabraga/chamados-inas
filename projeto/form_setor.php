...
<!-- Collapsable Form -->
<div class="card mb-4 collapse hide border-box" id="form_setor" style="max-width:700px">
    ...
    <div class="card-body">
        <form id="form_cadastro" action="save_setor.php" method="post">
            ...
            <div class="form-group row float-right">
                <button type="reset" onclick="$('#btn_cadastrar').show();" data-toggle="collapse" data-target="#form_setor" class="btn btn-danger btn-sm"><i class="fa fa-minus-square"></i> Cancelar</button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
